...
class ColmapGUI(QMainWindow):
    ...
    def process(self):
        ...
        if mode == "gsplat":
            ...
            self.worker = ColmapWorker(
                ...
                input_path,
                output_path,
                self.config_tab.get_input_type(),
    ...
    def stop_process(self):
        ...
        if (
            ...
            or (self.sharp_worker and self.sharp_worker.isRunning())
            or (
    ...
    def delete_dataset(self):
        ...
        has_dataset = (
            (target_path / "database.db").exists()
            or (target_path / "sparse").exists()
            or (target_path / "images").exists()
        )
    ...
    def train_brush(self, force_auto=False):
        ...
        self.brush_worker = BrushWorker(input_path, output_path, brush_params)
