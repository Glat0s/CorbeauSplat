...
class BrushTab(QWidget):
    ...
    def retranslate_ui(self):
        ...
        self.btn_train.setText(
            tr("btn_train_brush") if self.btn_train.isEnabled() else tr("btn_stop")
        )
    ...
    def on_reinstall_clicked(self):
        ...
        if reply == QMessageBox.StandardButton.Yes:
            ...
            try:
                ...
                QMessageBox.information(self, tr("btn_reinstall_brush"), tr("brush_reinstall_info"))
                self.restartRequested.emit()
            except Exception as e:
                QMessageBox.critical(
                    self, tr("msg_error"), f"Error deleting Brush installation: {e}"
                )
