...
class Extractor360Tab(QWidget):
    ...
    def start_install(self, install):
        ...
        self.lbl_status.setText(
            tr("360_status_installing") if install else tr("upscale_uninstalling")
        )
    ...
    def retranslate_ui(self):
        ...
        self.btn_extract.setText(
            tr("360_btn_extract_only") if self.btn_extract.isEnabled() else tr("msg_processing")
        )
